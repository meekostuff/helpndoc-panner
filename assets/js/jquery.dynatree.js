	...
	_activate: function(flag, fireEvents) {
		...
		if( flag ) {
			...
			if ( fireEvents && opts.onActivate ){
				// opts.onActivate.call(this.tree, this); // REMOVED
				return opts.onActivate.call(this.tree, this); // ADDED
			}
...
//      this.tree.logDebug("dtnode.activate(): %o", this);
		// this._activate(true, true); // REMOVED
		return this._activate(true, true); // ADDED
	},
