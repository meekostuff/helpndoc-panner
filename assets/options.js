...
Meeko.options = { // these are the default values
	...
	"file_access_from_files": true, // whether to support file: URLs when possible
	...
	"main_script": '{bootscriptdir}js/HyperFrameset/HyperFrameset.js', // use an abs-path or abs-url
